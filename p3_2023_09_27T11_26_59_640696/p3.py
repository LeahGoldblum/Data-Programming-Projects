...
min_budget_fire = agency_min("Fire")
min_budget_police = agency_min("Police")
min_budget_fire_police = min(min_budget_fire, min_budget_police)
...
total_budget_2019_to_2021 = year_budget(year=2019) + year_budget(year=2020) + year_budget(year=2021)
...
#     budget_start_year = year_budget(year=2019)
#     budget_end_year = year_budget(year=2023)
    ...
    change_per_year = (budget_difference / number_of_years)
...
# average change in the budget between `start_year` and `end_year`.
    avg_per_year = change_per_year(agency, start_year, end_year)
    first_year = project.get_budget(project.get_id(agency), start_year)
    predicted_year = first_year + (avg_per_year * (target_year - start_year))
...
parks_budget_2030 = extrapolate("Parks", 2030, start_year=2021)

print(parks_budget_2030)
...
police_diff_estimate_budget = project.get_budget(project.get_id("Police"), 2023) - extrapolate("Police", 2023, end_year=2022)

print(police_diff_estimate_budget)
...
metro_transit_diff_estimate_budget = project.get_budget(project.get_id("Metro Transit"), 2023) - extrapolate("Metro Transit", 2023, end_year=2022)

print(metro_transit_diff_estimate_budget)
...
mean = agency_avg("Metro Transit")
print(mean)
agency_id = project.get_id("Metro Transit")    
budget_2019 = project.get_budget(agency_id, 2019)
budget_2020 = project.get_budget(agency_id, 2020)
budget_2021 = project.get_budget(agency_id, 2021)
budget_2022 = project.get_budget(agency_id, 2022)
...
dev_2019 = (budget_2019 - mean)**2
dev_2020 = (budget_2020 - mean)**2
dev_2021 = (budget_2021 - mean)**2
dev_2022 = (budget_2022 - mean)**2
dev_2023 = (budget_2023 - mean)**2

metro_transit_budget_std_dev = ((dev_2019 + dev_2020 + dev_2021 + dev_2022 + dev_2023)/5)**(0.5)
